      ...
      <form>
        <div className="grid grid-cols-1 gap-4 items-center">
          ...
          <label className="items-center flex">
            ...
            {
              isLoggedIn ? (
                <button className="bg-blue-600 text-white h-full p-2 font-bold hover:bg-blue-200 hover:text-black">Book Now</button>
              ) : (
                <Link to={'signin'} className="bg-blue-600 text-white h-full p-2 font-bold hover:bg-blue-200 hover:text-black">Sign in to Book</Link>
              )
            }
        </div>
      </form>
